...
const QUESTIONS = [
  ...
  "Hemophilia is a genetic disorder which impedes the blood's ability to clot, which stops bleeding when a blood vessel is broken. If you could ensure your child would not be born with hemophilia, would you?",
